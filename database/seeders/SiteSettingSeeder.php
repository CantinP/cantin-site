...
class SiteSettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'youtube_channel_id',  'value' => '',                                      'type' => 'text', 'group' => 'stream',   'label' => 'ID chaîne YouTube (UCxxxx)', 'order' => 3],
            ['key' => 'youtube_api_key',     'value' => '',                                      'type' => 'text', 'group' => 'stream',   'label' => 'Clé API YouTube Data v3',    'order' => 4],
